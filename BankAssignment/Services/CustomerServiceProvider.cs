...
namespace BankAssignment.Services
{
    internal class CustomerServiceProvider
    {
        public void CustomerService()
        {
            ...
            ICustomerProviderImp customerProvider = new ICustomerProviderImp();
        Mainmenu: while (true)
            {
                ...
                switch (choice)
                {
                    case 1:
                        ...
                        customerProvider.GetAccountBalance(balId);
                    ...
                    case 2:
                        ...
                        try
                        {
                            ...
                            customerProvider.deposit(dId, money);
                        }
                        catch (Exception ex)
                        {
                    ...
                    case 3:
                        ...
                        try
                        {
                            ...
                            customerProvider.withdraw(dId1, withdrawAmount);
                        }
                        catch (Exception ex)
                        {
                            Console.WriteLine(ex.Message);
                    ...
                    case 4:
                        ...
                        customerProvider.TransferAmount(sender, receiver, transferAmount);
                    ...
                    case 5:
                        ...
                        try
                        {
                            ...
                            customerProvider.getAccountDetails(aId);
                        }
                        catch (Exception ex)
                        {
                            Console.WriteLine(ex.Message);
